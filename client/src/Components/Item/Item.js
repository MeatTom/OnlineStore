...
function Item ({id, name, imageURL, price, onPlus, description}) {
        ...
        <div className={ItemStyles.item}>
            ...
            <div className={ItemStyles.itemName}>
                ...
                <div className={ItemStyles.itemDescription}>
                    <p>Price:</p>
                    <b>$ {price}</b>
                    <svg onClick={onClickAdded} className={ItemStyles.addToCart} width="35" height="34" viewBox="0 0 35 34" fill="none" xmlns="http://www.w3.org/2000/svg">

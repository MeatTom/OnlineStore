                ...
                <div className={style.drawer}>
                    ...
                    <div className={style.cartItems}>
                            {items.map((item) => (
                                ...
                                <p>{item.name}<b>Price: {item.price}</b><br/>Amount: <br/>
                                    <button className={style.minusButton} onClick={() => decrementCartItem(item.id)}>-</button>
                                    {item.amount}
                                    <button className={style.plusButton} onClick={() => incrementCartItem(item.id)}>+</button>
                                </p>
